...
const InvoicePreview = () => {
  ...
  return data !== null && data.invoice !== undefined ? (
    ...
    <Alert color='danger'>
      <h4 className='alert-heading'>Document not found</h4>
      <div className='alert-body'>
        Document with id: {id} doesn't exist. Check list of all documents: <Link to='/document/list'>Document List</Link>
      </div>
    </Alert>
  )
}
